...
<#list children as child>
	//${child.code.moduleName}列表数据
	private List<${child.code.entityName}> ${child.code.entityName?uncap_first};
</#list>
...
<#list children as child>
	...
	public List<${child.code.entityName}> get${child.code.entityName}(){
		return ${child.code.entityName?uncap_first};
	}

	public void set${child.code.entityName}(List<${child.code.entityName}> ${child.code.entityName?uncap_first}){
		this.${child.code.entityName?uncap_first}=${child.code.entityName?uncap_first};
	}
</#list>
<#list columns as mData>
	<#if mData.type==10||mData.type==12>
