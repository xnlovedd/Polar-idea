...
<c:if test="${not empty pageScope.minLength&&pageScope.minLength>0}">polar-minLength="${pageScope.minLength}" </c:if>
...
<c:if test="${not empty pageScope.value}">value="${value}"</c:if>
