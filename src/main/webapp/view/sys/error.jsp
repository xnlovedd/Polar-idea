...
html, body{
    font-size: 100%;
	background: url(${ctxStatic}/imgs/banner.jpg) no-repeat 0px 0px;
...
<div class="main" style="padding-top: 200px;">
		<h1>出错啦</h1>
		<h2 style="margin-top: 20px">错误代码:${code},错误信息：${message}</h2>
		<div class="copyright" style="position: absolute; left: 0;bottom: 0;width: 100%">
			<p>© 恩哥做的页面，就是吊</p>
		</div>
	</div>
</body>
